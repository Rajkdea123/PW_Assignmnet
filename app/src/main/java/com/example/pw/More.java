...
public class More extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pitara.setOnClickListener(v -> {
            startActivity(new Intent(More.this, Pitara.class));
        });

        Maths.setOnClickListener(v -> {
            startActivity(new Intent(More.this, Maths.class));
        });
        Science.setOnClickListener(v -> {
            startActivity(new Intent(More.this, Science.class));
        });
        English.setOnClickListener(v -> {
            startActivity(new Intent(More.this, English.class));
        });
